...
public class AMGDPRSettings {
    ...
    public class func setConsentString(_ consentString: String) {
        UserDefaults.standard.set(consentString, forKey: AMGDPR_ConsentString)
    }

    /// Set the GDPR consent required in the SDK
    public class func setConsentRequired(_ consentRequired: NSNumber?) {
    ...
    public class func getConsentString() -> String? {
    ...
    public class func getConsentRequired() -> NSNumber? {
