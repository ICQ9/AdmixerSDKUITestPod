...
//        }
    ...
    func getGDPRConsentObject() -> AMGDPRDescription? {
        ...
        if gdprRequired != nil {
            if let gdprRequired = gdprRequired {
                return AMGDPRDescription(consentRequired: gdprRequired.intValue == 1, consentString: gdprConsent ?? "")
            }
            return nil
        } else {
            return nil
